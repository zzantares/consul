...
func TestServer_DeltaAggregatedResources_v3_NackLoop(t *testing.T) {
	...
	runStep(t, "first sync", func(t *testing.T) {
		...
		envoy.SendDeltaReqNACK(t, shared.ListenerType, 3, &rpcstatus.Status{})
...
func TestServer_DeltaAggregatedResources_v3_BasicProtocol_HTTP2_RDS_listenerChangesImpactRoutes(t *testing.T) {
	...
	runStep(t, "trigger listener update needing implicit route replacements", func(t *testing.T) {
		...
		envoy.SendDeltaReqACK(t, shared.EndpointType, 6)
		...
		// ACKs the listener
		envoy.SendDeltaReqACK(t, shared.ListenerType, 7)
