...
module(`Integration | Service | ${NAME}`, function (hooks) {
  ...
  skip('findAllByDatacenter returns the correct data for list endpoint', function (assert) {
  ...
  skip('findAllByNode calls findAllByDatacenter with the correct arguments', function (assert) {
    assert.expect(3);
