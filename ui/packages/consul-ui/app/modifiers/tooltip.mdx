...
Specific styles for the tooltip are kept in the components/tooltip folder.

## Positional Arguments

| Argument | Type | Default | Description |
| --- | --- | --- | --- |
| `value` | `String` |  | The text to be shown in the tooltip. If left unspecified it will use the DOM content of the DOM node you are modifying |

## Named Arguments

| Argument | Type | Default | Description |
| --- | --- | --- | --- |
| `options` | `Object` | `{}` | An object containing any documented tippy.js options |
