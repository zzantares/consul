...
<CodeTabs heading="Basic syntax for configuring an ACL rule"> <CodeBlockConfig lineNumbers>
...
</CodeBlockConfig> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Syntax for applying an ACL rule to named resources"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Syntax for resources that take ACL rule configurations directly"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example rule that denies access to services named 'web-prod'"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example rule that grants read and write access to services with names beginning with 'web'"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example rule that grants read access to all services"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example rules"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example acl rule"> <CodeBlockConfig>
...
<CodeTabs heading="Example admin partition rules"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example agent rules"> <CodeBlockConfig lineNumbers>
...
<CodeTabs heading="Example event rules"> <CodeBlockConfig>
...
<CodeTabs heading="Example key rules"> <CodeBlockConfig>
...
<CodeTabs heading="Example keyring rule"> <CodeBlockConfig>
...
<CodeTabs heading="Example mesh rule"> <CodeBlockConfig>
...
<CodeTabs heading="Example namespace rules"> <CodeBlockConfig>
...
1. `event` rules are not allowed.
1. `keyring` rules are not allowed.
1. `query` rules are not allowed.
1. `node` rules that attempt to grant `write` privileges are not allowed.
...
<CodeTabs heading="Example node rules"> <CodeBlockConfig>
...
<CodeTabs heading="Example operator rule"> <CodeBlockConfig>
...
<CodeTabs heading="Example query rules"> <CodeBlockConfig>
...
<CodeTabs heading="Example service rules"> <CodeBlockConfig>
...
1. Providing an ACL token with service and check definitions at registration
...
<CodeTabs heading="Example service rule with intentions"> <CodeBlockConfig>
...
<CodeTabs heading="Example session rules"> <CodeBlockConfig>
