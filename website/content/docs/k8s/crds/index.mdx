...
description: >-
  Consul supports managing configuration entries via Kubernetes Custom
  Resources. These custom resource can be used to manage the configuration for
  workloads deployed within the cluster.
---
