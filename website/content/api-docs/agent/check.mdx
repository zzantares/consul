...
it is far more convenient to use [maintenance mode](/api-docs/agent#enable-maintenance-mode)
rather than defining a TTL health check and using this endpoint.
